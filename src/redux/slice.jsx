...
const initialState = {
    ...
    thaliitems: [
        ...
        },
        {
          "id": 3,
          "name": "Daal",
          "description": "An Indian dish made of simmered and usually pureed and spiced legumes. Daal is veru good for health and it's give more immune",
  ...
  export const counterSlice = createSlice({
    ...
    reducers: {
      ...
      addTothali: (state, action) => {
        ...
        state.orderthali.push(action.payload);
      },
      RemoveItem:(state,action)=>{
         state.orderthali.splice(action.payload,1)
      },
    },
  })
